...
<nav class="navbar navbar-default">
    <div class="container">
      ...
      <li><a href="/adminlogin"><i class="fa fa-check"></i>admin login</a></li>
        <li><a href="/signIn"><i class="fa fa-check"></i> login</a></li>
        <li><a href="/userList"><i class="fa fa-edit"></i>Sign up </a></li>
      </ul>
    </div>
 </nav>   
</hr>
    <div id="login-overlay" class="modal-dialog">
      ...
      <div class="row">																																																																																																																																																																																																																																																																																																																																																												
                  ...
                  <div class="col-xs-6">
                      ...
                      <p><a href="/Maithili" class="btn btn-info btn-block">Register now!</a></p>
                  </div>
			<div class="col-xs-6">
                      <ul class="list-unstyled" style="line-height: 2">
                      ...
                      <p><a href="/resetPassword" class="btn btn-info btn-block">Reset Password</a></p>
                  </div>
              </div>
          </div>
      </div>
